...
public class NutritionSmoothies_Tab1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nutrition_smoothies_tab1, container, false);
    ...
    public void setUpFields() {
        tv1 = getView().findViewById(R.id.tv1Smoothies1);
        tv2 = getView().findViewById(R.id.tv2Smoothies1);
        tv3 = getView().findViewById(R.id.tv3Smoothies1);
        tv4 = getView().findViewById(R.id.tv4Smoothies1);
        tv5 = getView().findViewById(R.id.tv5Smoothies1);
        tv6 = getView().findViewById(R.id.tv6Smoothies1);
        diagram = getView().findViewById(R.id.ivSmoothies1Diagram);
    }//end setUpFields
    ...
    public void setData() {
        ...
        DocumentReference docRef = colref.document("Recipe 1");
