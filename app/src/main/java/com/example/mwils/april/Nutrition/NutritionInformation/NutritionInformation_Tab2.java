...
public class NutritionInformation_Tab2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nutrition_information_tab2, container, false);
    ...
    public void setUpFields() {
        tv1 = getView().findViewById(R.id.tv1NutInfo2);
        tv2 = getView().findViewById(R.id.tv2NutInfo2);

        diagram = getView().findViewById(R.id.ivNinfo2Diagram);
    }//end setUpFields
    ...
    public void setData() {
        ...
        DocumentReference docRef = colref.document("Fat");
