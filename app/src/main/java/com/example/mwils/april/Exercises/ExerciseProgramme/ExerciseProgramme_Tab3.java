...
public class ExerciseProgramme_Tab3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.exercise_programme_tab3, container, false);
    ...
    **/
    public void setUpFields() {
        ...
        tabtitle = getView().findViewById(R.id.tvEx3Title);
        exDescription = getActivity().findViewById(R.id.tvEx3Description);
        diagram = getActivity().findViewById(R.id.ivExcerise3Diagram);
        tracker = getActivity().findViewById(R.id.btnEx3Track);
    ...
    public void setData() {
        ...
        DocumentReference docRef = colref.document("Exercise 3");
