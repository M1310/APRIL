...
public class NutritionInformation_Tab3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nutrition_information_tab3, container, false);
    ...
    public void setUpFields() {
        tv1 = getView().findViewById(R.id.tv1NutInfo3);
        tv2 = getView().findViewById(R.id.tv2NutInfo3);

        diagram = getView().findViewById(R.id.ivNinfo3Diagram);
    }//end setUpFields
    ...
    public void setData() {
        ...
        DocumentReference docRef = colref.document("Fluid");
