...
public class NutritionMeals_Tab4 extends Fragment {
    ...
    public void setUpFields() {
        tv1 = getView().findViewById(R.id.tv1NutMeals4);
        tv2 = getView().findViewById(R.id.tv2NutMeals4);
        tv3 = getView().findViewById(R.id.tv3NutMeals4);
        tv4 = getView().findViewById(R.id.tv4NutMeals4);
        tv5 = getView().findViewById(R.id.tv5NutMeals4);
        diagram = getView().findViewById(R.id.ivNMeals4Diagram);
    }//end setUpFields
    ...
    public void setData() {
        ...
        DocumentReference docRef = colref.document("Snacks");
