...
public class NutritionInformation_Tab4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nutrition_information_tab4, container, false);
    ...
    public void setUpFields() {
        tv1 = getView().findViewById(R.id.tv1NutInfo4);
        tv2 = getView().findViewById(R.id.tv2NutInfo4);
        tv3 = getView().findViewById(R.id.tv3NutInfo4);
        tv4 = getView().findViewById(R.id.tv4NutInfo4);
        tv5 = getView().findViewById(R.id.tv5NutInfo4);
        tv6 = getView().findViewById(R.id.tv6NutInfo4);
        diagram = getView().findViewById(R.id.ivNinfo4Diagram);
    }//end setUpFields
    ...
    public void setData() {
        ...
        DocumentReference docRef = colref.document("Protein");
