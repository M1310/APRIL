...
public class NutritionSmoothies_Tab2 extends Fragment {
    ...
    public void setUpFields() {
        tv1 = getView().findViewById(R.id.tv1Smoothies2);
        tv2 = getView().findViewById(R.id.tv2Smoothies2);
        tv3 = getView().findViewById(R.id.tv3Smoothies2);
        tv4 = getView().findViewById(R.id.tv4Smoothies2);
        tv5 = getView().findViewById(R.id.tv5Smoothies2);
        tv6 = getView().findViewById(R.id.tv6Smoothies2);
        diagram = getView().findViewById(R.id.ivSmoothies2Diagram);
    }//end setUpFields
    ...
    public void setData() {
        ...
        DocumentReference docRef = colref.document("Recipe 2");
