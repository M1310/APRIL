...
public class ExerciseProgramme_Tab6 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.exercise_programme_tab6, container, false);
    ...
    public void setUpFields() {
        title ="";
        tabtitle = getView().findViewById(R.id.tvEx6Title);
        exDescription = getActivity().findViewById(R.id.tvEx6Description);
        diagram = getActivity().findViewById(R.id.ivExcerise6Diagram);
        tracker = getActivity().findViewById(R.id.btnEx5Track);
    ...
    public void setData() {
        ...
        //Accidentally added a space to the end of the Exercise 6 document, so it needs to be in here too
        DocumentReference docRef = colref.document("Exercise 6 ");
        ...
        docRef.get()
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        System.out.println("HERE 1 "+title);
