...
public class NutritionMeals_Tab3 extends Fragment {
    ...
    public void setUpFields() {
        tv1 = getView().findViewById(R.id.tv1NutMeals3);
        tv2 = getView().findViewById(R.id.tv2NutMeals3);
        tv3 = getView().findViewById(R.id.tv3NutMeals3);
        tv4 = getView().findViewById(R.id.tv4NutMeals3);
        diagram = getView().findViewById(R.id.ivNMeals3Diagram);
    }//end setUpFields
    ...
    public void setData() {
        ...
        DocumentReference docRef = colref.document("Dinner");
